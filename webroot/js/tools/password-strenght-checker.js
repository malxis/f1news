...
window.simple_password_checker = {
	...
	text_weak: "<i class='fa-solid fa-circle-xmark'></i> Mot de passe faible",
	text_good: "<i class='fa-solid fa-circle-xmark'></i> Mot de passe moyen",
	text_strong: "<i class='fa-solid fa-circle-check'></i> Mot de passe fort",

	css_weak : 'badge bg-danger',
	css_good : 'badge bg-warning',
	css_strong : 'badge bg-success',
